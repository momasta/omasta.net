...
* Roads
  * Large roads
    * Long yellow middle lines
    * Solid white outer lines
  * Small roads
    * Long outer dashes
      * 🇫🇮 Finland: dashes only in Åland
* Regions
  * Far south
    * Oaks and maples
    * White wooden houses
      * Entire villages of them.
      * More common here.
  * Oslo area
    * Flat farmlands
  * Trondheim area
    * Farmlands surrounded by hills
  * Lofoten Archipelago (NW)
    * Sharp rocky mountains
      * Few trees
  * NE
    * Rolling landscape
    * Small birches
...
* Regions
  ...
  * Basque Country
    * Bilbao to Donostia along the coast.
    * North of the Ebro river
    * Spills over to 🇫🇷 France (Bayonne)
    * Basque language
      * Z and K very common
      * Signs often bilingual
  * Galicia
    * Western peninsula
    * Town names start with articles: A, O, As, Os.
  ...
  * Canary Islands
    * Black volcanic rock
* Roads
  * Dashed outer lines in places
    * Unique in Southern Europe
  * Light orange reflectors
* Signs
  * Signs with no edges
...
* Licence Plates
  * Front plates on bikes
    * 🇲🇾 Malaysia: not mandatory
  * White on black
    * 3 sections (🇲🇾 Malaysia: 2)
* Look and Feel
  * Small shops
    * Abundance of cigarette adverts
* Roads
  * Bike taxis
    * Green clothing
  * Abundance of motorbikes
* Signs
  * No edges
...
* Language
  * Former British colony
    * More likely to use English
  * Latin + 🇨🇳 Chinese characters
* Licence Plates
  * White on black
  * 2 sections (🇮🇩 Indonesia: 3)
* Poles
  * Black rectangular stickers (mainland only)
* Roads
  * White lines
    * Unique in Southeast Asia
  * Double white centre lines
  * Generally in better shape than 🇮🇩 Indonesia
* Signs
  * 🛑 BERHENTI
  * ⛛ BERI LALUAN
  * Signs with edges
...
* Roads
  ...
  * Double yellow outside lines
  * HUMP AHEAD / HUMPS AHEAD
* Signs
  * Street Signs
    * Green
    * Rounded edges
...
* Regions
  * North
    ...
    * Red River Delta
      ...
      * Tall slender boxy houses
  * South
    * Landscape
      * Dragon fruit farms (coast)
      * Black pepper
    * Poles
      * Round poles with pinholes
    * Mekong Delta
      * Straight canals
      * Linear villages
      * Very tropical
      * Wetlands
* Roads
  * White bollards with a red top
* Signs
  * Yellow-orange background
    * Unique within Southeast Asia
...
* Licence Plates
  * Dark blue tint
  * Some with a hint of green on the left
* Regions
  * North
    * Flat
  * South
...
* Landscape
  * Cacti
* Language
  * Many place names of Nahuatl origin
    * x
    * tl
    * -ec
    * -tlan
* Look and Feel
  * Circular electricity metres
* Poles
  * Octagonal
* Regions
  * Mexico City
    * Marshmallow taxis
* Roads
  * Yellow kerbs and barriers
  * Oxxo and Pemex petrol stations
* Signs
  * Thick arrows
...
* Regions
  * South
    * German architecture
      * Mainly Santa Catarina
* Roads
  * Black back of road signs
  * Double yellow middle lines
    * Single yellow = not Brazil
* Signs
  * Street Signs
    * CEP (postcode)
      * Counter-clockwise
      * Starting in São Paulo
      * Ending in Rio Grande do Sul
      * NW: 69 (AM, Amazonas)
      * Dense along the coast
  * Chevrons
    * Yellow on black
...
* Licence Plates
  * Commercial
    * Orange
    * Newer with orange strip at the top
* Roads
  * Double guardrails
* Signs
  * Highway shields similar to 🇺🇸 US interstate
  * Square
  * White background
...
* Poles
  * Trident
* Roads
  * Thick white sign poles
  * Messy yellow/white road markings
  * Yellow chevrons
...
* Roads
  ...
  * Red and white chevrons
    ...
    * Not in Australia
* Signs
  * N-roads displayed as blue pentagons on Google Maps
    * "N" not shown
...
* Regions
  ...
  * Western Australia
    ...
    * Red soil
* Roads
  * All-white road lines (almost exclusively)
* Signs
  * Speed limit sign
